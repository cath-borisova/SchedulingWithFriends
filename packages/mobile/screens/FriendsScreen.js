        ...
        {addFriends &&
          <View style={styles.overlay}>
            ...
            <View style={styles.row2}>
              <Pressable onPress={() => setAddFriends(false)} style={{fontFamily: "JetBrainsMono-Regular", flex:1, marginBottom: 15, alignSelf: 'flex-start'}}><Text style={{fontSize: normalizeHeight(26), alignSelf: 'center'}}>Add</Text></Pressable>
